...
#     time.sleep(1)
#     driver.find_element(By.XPATH, '//*[@id="userEmail"]').send_keys("john.doe@example.com")
#     time.sleep(1)
#     driver.find_element(By.ID, 'userNumber').send_keys("1234567890")
#     driver.find_element(By.ID, 'currentAddress').send_keys("123 Main Street, Anytown")

#     time.sleep(1)
#     driver.find_element(By.XPATH, "//label[text()='Male']").click()

#     time.sleep(1)
#     driver.find_element(By.XPATH, "//*[text()='Sports']").click()
#     driver.find_element(By.XPATH, "//*[text()='Reading']").click()
#     time.sleep(1)
#     driver.find_element(By.ID, "dateOfBirthInput").click()
#     #Year
#     year_dropdown = driver.find_element(By.XPATH, '//*[@id="dateOfBirth"]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[2]/select')
#     Select(year_dropdown).select_by_visible_text("2000")
#     time.sleep(1)
#     #Month
...
#     time.sleep(1)
#     #Day
#     driver.find_element(By.XPATH, '//*[@id="dateOfBirth"]/div[2]/div[2]/div/div/div[2]/div[2]/div[3]/div[7]').click()
#     time.sleep(1)
#     driver.find_element(By.ID, "uploadPicture").send_keys("C://Users//islam//Downloads//images.jpg")
    
#     # time.sleep(1)
#     driver.find_element(By.ID, "state").click()
#     driver.find_element(By.XPATH, "//*[text()='NCR']").click()
#     time.sleep(1)
